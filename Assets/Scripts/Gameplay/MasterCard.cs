...
namespace Gameplay
{
    ...
    public class MasterCard : MonoBehaviour
    {
        ...
        [SerializeField] protected Transform completeCardSlot;
        [SerializeField] protected Transform separateCardSlot;
        [SerializeField] protected Transform detectionZone;

        [SerializeField] private float separateGap;
        [SerializeField] private float combineGapFactor;
        
        protected bool _canCheckout = false;

        protected Card _completeCard;
        ...
        protected Transform _activatedSlot;
        ...
        protected BoxCollider2D _boxCollider2DComponent;
        ...
        protected virtual void SpawnMainCard(CardData cardData, CardType cardType)
        {
        ...
        protected void RefreshMasterCardData()
        {
        ...
        {
            _separatedCardA.transform.DOLocalMoveY(5f, .2f);
        }
